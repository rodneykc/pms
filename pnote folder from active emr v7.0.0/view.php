...
<div class="container">
    <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12">
            <form class="form" method=post action="<?php echo $rootdir . "/forms/" . $form_name . "/save.php?mode=update&id=" . attr_url($_GET["id"]);?>" name="my_form" id="my_form">
            ...
            <br />
            <textarea class="form-control" name="message" id="message" cols ="147" rows="7"><?php echo text($obj["message"]);?></textarea>
            <br /> <br />
            ...
            <!--<input type="button" class="btn btn-secondary printform" value="<?php //echo xla('View Printable Version'); ?>">--> &nbsp;
            </div>
